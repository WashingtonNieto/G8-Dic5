...
import com.g8Dic5.demo.services.OrderService;
...
public class OrderController {
    ...
    public List<Order> ordersSalesManByDate(@PathVariable("id") Integer id){
        return orderService.orderSalesManByDate(id);
    }
